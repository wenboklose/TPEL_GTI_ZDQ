...
sys = linearize('VSI_GT_avg_Zol_pll_ideal',0.5);
%% Zin model linearization
H=ss(sys);
Vavg1=[H(1,1) H(1,2);
    H(2,1) H(2,2);];
...
Zin_pll_cal_ideal = 1/(1/Zo_cal+Gid_cal*Gdpll);
Yin_cal=1/Zo_cal;
...
Bode_Darklines(3)
% smform(Zin_pll_avg_sim.a,Zin_pll_avg_sim.b,Zin_pll_avg_sim.c,Zin_pll_avg_sim.d)
% 
% % figure(2)
