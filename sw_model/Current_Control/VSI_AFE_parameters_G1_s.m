...
Kpi_VSI		= 6.2832/Vdc;           % current loop bandwidth 1k: 2pi*bandwidth_i*Lout
Kii_VSI		= 10*628.3185/Vdc;      % current loop bandwidth 1k: 2pi*bandwidth_i*R_Lout
Kppq_VSI	= 70*4e-5;
Kipq_VSI	= 70;
%% VSI PLL parameters
...
Kp_PLL_VSI  = 8.921;        % pll bandwidth 100 Hz
Ki_PLL_VSI  = 3964;         % pll bandwidth 100 Hz
